defmodule DOMSegServerWeb.Router do
  use DOMSegServerWeb, :router

  import DOMSegServerWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {DOMSegServerWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: DOMSegServerWeb.Telemetry
    end
  end
